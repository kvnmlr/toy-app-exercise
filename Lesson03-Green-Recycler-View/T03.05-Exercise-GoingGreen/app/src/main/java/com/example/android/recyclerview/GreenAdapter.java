...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        String viewHolderIndex = "ViewHolder index: " + mViewHolderCount;

        // Completed (13) Use ColorUtils.getViewHolderBackgroundColorFromInstance and pass in a Context and the viewHolderCount
        int color = ColorUtils.getViewHolderBackgroundColorFromInstance(context, mViewHolderCount);
        ...
        mViewHolderCount++;
        Log.d(TAG, mViewHolderCount + " view holders");
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView mViewHolderIndexTextView;
        ...
        public NumberViewHolder(View itemView) {
            ...
            mViewHolderIndexTextView = (TextView) itemView.findViewById(R.id.tv_view_holder_instance);
        }
